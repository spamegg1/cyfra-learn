...
class CpuBlurSuite extends ImgSuite:
  test("CpuBlur.blur with radius 1 should correctly blur the entire 3x3 image"):
    val w          = 3
    val h          = 3
    val src        = Img(w, h)
